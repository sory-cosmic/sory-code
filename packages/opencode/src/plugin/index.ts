...
import { EnvironmentAdapterType, EnvironmentAdapter } from "@/control-plane/adapters/environment-adapter"
  ...
  Effect.gen(function* () {
    ...
    const state = yield* InstanceState.make<State>(
      Effect.fn("Plugin.state")(function* (ctx) {
        ...
        // Authoritative project environment: target resolution reads the
        // persisted Project.environment (local/codespaces/sandbox).
        registerAdapter(ctx.project.id, EnvironmentAdapterType, EnvironmentAdapter)
