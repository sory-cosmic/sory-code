...
import { Config as EnvironmentConfig } from "@opencode-ai/schema/environment"
...
export function fromRow(row: Row): Info {
  ...
  return {
    ...
    environment: row.environment ?? { kind: "local", directory: row.worktree },
  }
}
...
export const UpdateInput = Schema.Struct({
  ...
  environment: Schema.optional(EnvironmentConfig),
})
    ...
    const fromDirectory = Effect.fn("Project.fromDirectory")(function* (directory: string) {
      ...
      const existing = row
        ...
        : {
            ...
            sandboxes: [] as string[],
            environment: { kind: "local", directory: worktree },
