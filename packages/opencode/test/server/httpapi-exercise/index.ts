  ...
  http.protected
    ...
    .at((ctx) => ({
      ...
      body: {
        ...
        commands: { start: "bun --version" },
        environment: { kind: "codespaces", repository: "sory/example", remoteURL: "https://workspace.example.test" },
      },
    }))
    .json(
      200,
      (body) => {
        ...
        check(
          isRecord(body.environment) && body.environment.kind === "codespaces",
          "project update should return the execution environment",
        )
      },
      "status",
    ),
