...
export const dict = {
  ...
  "dialog.project.edit.sandbox.connectHint": "Paste a provider token once — it is stored securely, never in the project.",
  "dialog.project.edit.sandbox.connectE2b": "Connect E2B key",
  "dialog.project.edit.sandbox.connectVercel": "Connect Vercel token",
  "dialog.project.edit.sandbox.urlLabel": "Sandbox workspace URL (optional)",
  "dialog.project.edit.sandbox.urlDescription":
    "Leave empty: the sandbox is provisioned automatically when you open a terminal.",
  "dialog.project.edit.sandbox.connectedKey": "Connected (API key)",
  "dialog.project.edit.sandbox.connectedEnv": "Connected (environment variable)",
  "dialog.project.edit.sandbox.notConnected": "Not connected",
  "dialog.project.edit.sandbox.providerNote":
    "The provider actually used is the one configured on the server (SANDBOX_PROVIDER, default Vercel).",
  ...
  "session.new.environment.change": "Execution environment — click to change",
