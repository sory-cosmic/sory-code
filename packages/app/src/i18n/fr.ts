export const dict = {
  ...
  "dialog.project.edit.sandbox.connectHint": "Collez un jeton une seule fois — il est stocké en sécurité, jamais dans le projet.",
  "dialog.project.edit.sandbox.connectE2b": "Connecter la clé E2B",
  "dialog.project.edit.sandbox.connectVercel": "Connecter le jeton Vercel",
  "dialog.project.edit.sandbox.urlLabel": "URL de l'espace sandbox (optionnel)",
  "dialog.project.edit.sandbox.urlDescription":
    "Laissez vide : le sandbox sera provisionné automatiquement à l'ouverture d'un terminal.",
  "dialog.project.edit.sandbox.connectedKey": "Connecté (clé API)",
  "dialog.project.edit.sandbox.connectedEnv": "Connecté (variable d'environnement)",
  "dialog.project.edit.sandbox.notConnected": "Non connecté",
  "dialog.project.edit.sandbox.providerNote":
    "Le provider réellement utilisé est celui configuré côté serveur (SANDBOX_PROVIDER, défaut Vercel).",
  ...
  "session.new.environment.local": "PC local",
  "session.new.environment.codespaces": "GitHub Codespaces",
  "session.new.environment.sandbox": "Sandbox cloud",
  "session.new.environment.change": "Environnement d'exécution — cliquer pour modifier",
